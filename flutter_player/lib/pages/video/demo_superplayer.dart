...
import 'package:flutter_player/pages/video/ui/demo_inputdialog.dart';
import 'package:flutter_easyloading/flutter_easyloading.dart';
import 'package:super_player/super_player.dart';
import 'dart:ui';
import 'package:superplayer_widget/demo_superplayer_lib.dart';

import 'demo_download_list.dart';
...
class _DemoSuperPlayerState extends State<DemoSuperPlayer> with TXPipPlayerRestorePage {
                  ...
                  actions: [
                    InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset('assets/images/player/superplayer_ic_vod_download_list.png'),
                        ))
                  ],
                ),
          body: SafeArea(
  ...
  Widget getBody() {
    return Column(
      children: [
        _getPlayArea(),
        Expanded(flex: 1, child: _getListArea()),
        _getAddArea()
      ],
    );
  }
