...
import 'package:flutter_player/pages/video/res/app_localizations.dart';
...
class DemoDownloadList extends StatefulWidget {
  const DemoDownloadList({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        ...
        image: AssetImage("assets/images/player/ic_new_vod_bg.png"),
        fit: BoxFit.cover,
      )),
      child: Scaffold(
